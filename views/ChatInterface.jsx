...
export function ChatInterface({ socket, selectedUser, messages, onSendMessage, onBack }) {
    ...
    return (
        <div className="flex flex-col h-full w-full bg-[#f8fafc] dark:bg-[#0F172A]">
            ...
            {/* Messages Area — overflow-y-auto only shows scrollbar when content actually overflows */}
            <div className="flex-1 flex flex-col overflow-y-auto px-2 md:px-6 py-3 md:py-6 space-y-3 md:space-y-6 scroll-smooth">
                {messages.length === 0 && (
                    <div className="flex-1 flex flex-col items-center justify-center text-center text-gray-500 dark:text-gray-400 px-4">
                        <div className="w-14 h-14 md:w-16 md:h-16 mb-3 md:mb-4 rounded-full bg-indigo-50 dark:bg-indigo-900/20 flex items-center justify-center">
